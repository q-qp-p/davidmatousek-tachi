...
You consume the complete `threats.md` file produced by the orchestrator. You parse specific sections relevant to infographic data extraction.

**Critical constraint**: You do NOT consume `threat-report.md` or any other pipeline output. You run in a fresh context with only `threats.md` as input (context isolation).
