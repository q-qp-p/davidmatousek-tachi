...
This is a standalone threat analysis prompt for the **Information Disclosure** threat category.

**Input**: Provide the architecture components assigned to this agent by the orchestrator (from Step 4 of `00-orchestrator.md`).
...
Each finding produced by this agent must use the following field structure:
