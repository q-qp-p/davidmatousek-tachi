...
│  Subtitle: "{input_format} — {total_findings} Findings Across           │
...
| Aesthetic | Premium, polished, boardroom-ready dark dashboard |
...
- Subtitle: "{description} — {total_findings} Findings Across {category_count} Threat Categories"
...
- "Generated by Tachi Threat Modeling Framework — OWASP STRIDE + AI Threat Analysis"
...
```
Create a premium, boardroom-ready security risk dashboard with a polished, modern dark-theme aesthetic. This should look like a professionally designed Figma dashboard — not a data table or spreadsheet. The overall feel should be confident, sophisticated, and visually impressive — something a CISO would proudly present to a board of directors.
...
TOP SECTION: Title "Threat Model: {project_name}" in large white bold text. Date "{date}" and a "CONFIDENTIAL" pill badge in red (#DC2626) with white text, right-aligned. Subtitle below in light gray: "{description} — {total_findings} Findings Across {category_count} Threat Categories".
...
FOOTER: "Generated by Tachi Threat Modeling Framework — OWASP STRIDE + AI Threat Analysis" in small light gray text, centered.

The overall impression should be a polished executive briefing document — confident, clear, and visually sophisticated.
```
