...
description: "Transforms structured threat model output into a visual risk specification with six required sections and optionally produces a presentation-ready infographic image via Gemini API for executive audiences."
---
