...
```python
{
    ...
    "src_content": str,                     # exact bytes written to tmp_path/src (typically "{{PROJECT_NAME}}\n")
...
- `marker` MUST name the regression class (e.g., "AT&T → AT{{PROJECT_NAME}}T corruption" for case 1).
