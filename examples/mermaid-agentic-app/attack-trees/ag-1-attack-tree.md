# Attack Tree: AG-1 — Autonomous execution of consequential tool calls without human approval
...
| Risk Level | Critical |
| Threat | Autonomous execution of consequential tool calls without human approval |
| Correlation | None |
