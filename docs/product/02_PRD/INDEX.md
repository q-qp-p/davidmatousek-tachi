...
**Last Updated**: 2026-05-08 (F-3 SECURITY.md and Private Disclosure Channel #272 PRD APPROVED v1.1 — BLP-02 Wave 3 (3/5) entering plan stage; closes TACHI-VULN-05abc41ad4cc (INFO, A05 Security Misconfiguration) from 2026-05-02 /security scan; SECURITY.md rewrite to GitHub-canonical sections (Supported Versions / Reporting / Response SLA / Scope / Out-of-scope), Private Vulnerability Reporting toggle in repo settings, README.md one-line pointer, CHANGELOG entry; ~100 LOC, no code changes, no ADR; Triad reviews: PM ✓ (authored v1.1), Architect ⚠ APPROVED_WITH_CONCERNS v1.1 (v1.0 had 2 BLOCKING — C-1 v4.32.0 reference resolved via post-fetch verification, C-2 90-day deprecation policy resolved via Option A latest-minor-only switch; C-3/C-4 wording fixes landed; R-6 GitHub vendor-lock added), Team-Lead ⚠ APPROVED_WITH_CONCERNS v1.0 (5 non-blocking advisories all folded in including AC-2 cross-check operationalization, AC-11/AC-12 promoted to mandatory, AC-13 posture-probe and AC-14 manifest-discrepancy committed as post-merge follow-on Issues); same-day-or-next-day delivery target. Prior: F-2 Source-Pattern Hardening #256 DELIVERED 2026-05-05 — BLP-02 Wave 2 complete; 5 /security vuln_ids closed (2 HIGH + 2 MEDIUM + 1 LOW) on bash source/eval surface; canonical `aod_template_load_kv_file` primitive shipped (`template-config-load.sh`); refactored 4 source/eval sites + portable git clone timeout watchdog; ADR-040 *Config File Parsing Hardening* Proposed→Accepted (dual-commit pattern); 9 new test files + adversarial fixture corpus; 62 tasks complete; PR #257 squash-merged 2026-05-05 (SHA f959622); ~24h delivery envelope; PM ✓, Architect ✓, Team-Lead ⚠. Prior: F-250 Adversarial Unit Extraction Hot-Fix DELIVERED — 12 adversarial cases extracted to unit-level pytest modules + Phase 6 Option Z permanent CI test process hardening; PR #253 squash-merged 2026-05-04T16:39:23Z; PM ✓, Architect ⚠, Team-Lead ⚠. Prior: F-248 Substitution Surface Hardening DELIVERED — BLP-02 Wave 1 complete; 5 /security findings closed; PR #249 squash-merged 2026-05-04)
**Legend**: ✓=APPROVED, ⚠=APPROVED_WITH_CONCERNS, 🔄=CHANGES_REQUESTED, ⛔=BLOCKED, ⚠⚡=OVERRIDDEN


| # | Feature | PM | Architect | Team-Lead | Status | Date |
|---|---------|----|-----------|-----------| -------|------|
| 272 | [F-3 SECURITY.md and Private Disclosure Channel (BLP-02 Wave 3)](272-security-md-disclosure-2026-05-08.md) | ✓ | ⚠ | ⚠ | Approved | 2026-05-08 |
