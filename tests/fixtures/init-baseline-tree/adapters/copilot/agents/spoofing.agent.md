---
name: tachi-spoofing
description: "STRIDE spoofing threat agent — detects identity impersonation, authentication bypass, credential theft, session hijacking, and federated identity attacks against External Entities and Processes."
