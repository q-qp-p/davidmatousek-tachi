...
This is a standalone threat analysis prompt for the **Denial of Service** threat category.

**Input**: Provide the architecture components assigned to this agent by the orchestrator (from Step 5 of `00-orchestrator.md`).
