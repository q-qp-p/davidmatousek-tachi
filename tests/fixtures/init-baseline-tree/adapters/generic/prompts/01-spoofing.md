...
This is a standalone threat analysis prompt for the **Spoofing** threat category.

**Input**: Provide the architecture components assigned to this agent by the orchestrator (from Step 1 of `00-orchestrator.md`).
