...
Not yet defined        - Cloud platform (Vercel → AWS/Railway/etc)
...
| `Not yet defined` | Vercel | Cloud deployment platform |
...
sed -i 's/Not yet defined/Railway/g' .claude/agents/*.md .claude/commands/*.md
...
sed -i 's/Not yet defined/AWS/g' .claude/agents/*.md .claude/commands/*.md
