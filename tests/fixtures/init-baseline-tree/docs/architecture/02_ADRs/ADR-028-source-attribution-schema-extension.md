...
**Accepted-commit-SHA**: `6d5d890c388af5f546246f4e39f8a4d61fe840b1`
...
**2026-04-17 (Accepted — Feature 189, T036 post-merge SHA fill)**: PR #190 squash-merged to `main` at 2026-04-18 01:11:04 UTC with commit SHA `6d5d890c388af5f546246f4e39f8a4d61fe840b1`. `Accepted-commit-SHA` field on line 5 updated from `<pending-post-merge-fill>` placeholder to the actual squash-merge SHA per Decision 7 dual-commit governance protocol and F-A1 / ADR-027 T039 precedent. **Provisional Accepted-date 2026-04-17 retained** (not corrected to UTC merge date 2026-04-18) per ADR-027 T039 guidance: the provisional date reflects the Wave 6.1 T031 authoring-time projection in repo-local timezone, and the paired `<pending-post-merge-fill>` placeholder satisfies the "provisional date AND SHA-fill post-merge" pattern; correcting the date would retcon the Wave 6.1 T031 transition record without adding provenance value beyond what the new SHA field now provides. Merge occurred the same local calendar day as the Wave 6.1 T031 transition (2026-04-17 local), confirming the single-day cadence for F-A2's 6-wave build. This entry closes the T031 post-merge-fill dependency; all 7 Decisions are carried forward unchanged. No substantive content updates; provenance-strengthening only.
