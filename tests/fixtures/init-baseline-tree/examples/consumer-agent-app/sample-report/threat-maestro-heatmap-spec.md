...
### Component-Layer Heatmap

| Component | L1 | L2 | L3 | L4 | L5 | L6 | L7 | Unclassified | Total |
|-----------|----|----|----|----|----|----|----|-------------|-------|
| WellnessCompanionChatbot | — | — | — | — | — | — | High (11) | — | 11 |
| End User | — | — | — | — | — | — | High (2) | — | 2 |
| Interaction Audit Log | — | — | — | — | Medium (3) | — | — | — | 3 |
| Conversation Session Store | — | — | — | — | — | — | — | Medium (3) | 3 |

**MAESTRO Data Status**: Same `has_maestro_data: false` note as maestro-stack — the manual heatmap reconstruction above is derived from threats.md Phase 1 Component Inventory's MAESTRO Layer column. The JPEG render uses the same data via the natural-language DATA CONTENT block.
...
Component x Layer Grid (16:9 landscape):

1. **TITLE BAND (~10%)**: Project name + total finding count + residual risk summary
2. **GRID CANVAS (~85%)**: rows = components, columns = L1..L7 + Unclassified; cells colored by highest residual severity at that intersection
