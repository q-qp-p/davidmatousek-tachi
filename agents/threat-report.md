...
description: >
  ...
  and High findings, prioritized remediation roadmap with effort estimates,
  and complete finding traceability. Produces threat-report.md and
  standalone attack tree files.
